...
gint get_selected_split_mode(ui_state *ui) { return ui->status->selected_split_mode; }

void set_selected_split_mode(gint value, ui_state *ui) { ui->status->selected_split_mode = value; }
...
static void split_mode_changed(GtkToggleButton *radio_b, ui_state *ui)
{
  ...
  if (selected_split_mode == SELECTED_SPLIT_SILENCE) { activate_silence_parameters(ui->gui); }
  else { deactivate_silence_parameters(ui->gui); }

  if (selected_split_mode == SELECTED_SPLIT_TRIM_SILENCE) { activate_trim_parameters(ui->gui); }
  else { deactivate_trim_parameters(ui->gui); }
...
static GtkWidget *create_split_mode(ui_state *ui)
{
  ...
  gtk_widget_set_tooltip_text(
    split_mode_radio_button, _("Split files using the manually defined splitpoints"));
  ...
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  g_object_set_data(
    G_OBJECT(split_mode_radio_button), "split_type_id", GINT_TO_POINTER(SELECTED_SPLIT_NORMAL));
  ...
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  g_object_set_data(
    G_OBJECT(split_mode_radio_button), "split_type_id", GINT_TO_POINTER(SELECTED_SPLIT_TIME));
  ...
  gtk_widget_set_tooltip_text(
    split_mode_radio_button, _("Create smaller tracks having exactly the same time length"));
  ui->gui->split_mode_radio_button = split_mode_radio_button;
  gtk_box_pack_start(GTK_BOX(local_vbox), split_mode_radio_button, FALSE, FALSE, 2);
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  ...
  g_signal_connect(
    G_OBJECT(spinner_equal_tracks), "value-changed", G_CALLBACK(spinner_equal_tracks_changed), ui);
  ...
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  g_object_set_data(
    G_OBJECT(split_mode_radio_button), "split_type_id", GINT_TO_POINTER(SELECTED_SPLIT_SILENCE));
  ...
  GtkWidget *all_shots_label = gtk_label_new(_("Shots as non silence after silence: "));
  ui->gui->all_shots_label = all_shots_label;
  gtk_box_pack_start(GTK_BOX(horiz_fake), all_shots_label, FALSE, FALSE, 0);

  adj = gtk_adjustment_new(25.0, 0.0, 500.0, 1.0, 10.0, 0.0);
  GtkWidget *all_spinner_silence_shots = gtk_spin_button_new(adj, 1.0, 0);
  ui->gui->all_spinner_silence_shots = all_spinner_silence_shots;
  gtk_box_pack_start(GTK_BOX(horiz_fake), all_spinner_silence_shots, FALSE, FALSE, 0);
  ...
  GtkWidget *all_offset_label =
    gtk_label_new(_("Cutpoint offset (0 is the begin of silence,and 1 the end) : "));
  ...
  GtkWidget *all_number_of_tracks_label =
    gtk_label_new(_("Number of tracks (0 means all tracks) : "));
  ...
  gtk_spin_button_set_value(
    GTK_SPIN_BUTTON(all_spinner_silence_number_tracks), SPLT_DEFAULT_PARAM_TRACKS);
  gtk_spin_button_set_value(
    GTK_SPIN_BUTTON(all_spinner_silence_minimum), SPLT_DEFAULT_PARAM_MINIMUM_LENGTH);
  gtk_spin_button_set_value(GTK_SPIN_BUTTON(all_spinner_silence_offset), SPLT_DEFAULT_PARAM_OFFSET);
  gtk_spin_button_set_value(
    GTK_SPIN_BUTTON(all_spinner_silence_threshold), SPLT_DEFAULT_PARAM_THRESHOLD);
  gtk_spin_button_set_value(
    GTK_SPIN_BUTTON(all_spinner_trim_silence_threshold), SPLT_DEFAULT_PARAM_THRESHOLD);

  deactivate_silence_parameters(ui->gui);
  deactivate_trim_parameters(ui->gui);

  //wrap split
  split_mode_radio_button =
    gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(split_mode_radio_button),
  ...
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  g_object_set_data(
    G_OBJECT(split_mode_radio_button), "split_type_id", GINT_TO_POINTER(SELECTED_SPLIT_WRAP));
  ...
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  g_object_set_data(
    G_OBJECT(split_mode_radio_button), "split_type_id", GINT_TO_POINTER(SELECTED_SPLIT_ERROR));

  //internal sheet mode split
  split_mode_radio_button =
    gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(split_mode_radio_button),
      _("Internal sheet mode (CUE sheet for FLAC and ID3v2 chapters for MP3)"));
  ...
  split_mode_radio_button =
    gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(split_mode_radio_button),
      _("Use CUE file with similar name as the input file"));
  gtk_widget_set_tooltip_text(split_mode_radio_button,
  ...
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  g_object_set_data(
    G_OBJECT(split_mode_radio_button), "split_type_id", GINT_TO_POINTER(SELECTED_SPLIT_CUE_FILE));

  //CDDB file with the same name as the input file
  split_mode_radio_button =
    gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(split_mode_radio_button),
      _("Use CDDB file with similar name as the input file"));
  gtk_widget_set_tooltip_text(split_mode_radio_button,
  ...
  g_signal_connect(
    GTK_TOGGLE_BUTTON(split_mode_radio_button), "toggled", G_CALLBACK(split_mode_changed), ui);
  g_object_set_data(
    G_OBJECT(split_mode_radio_button), "split_type_id", GINT_TO_POINTER(SELECTED_SPLIT_CDDB_FILE));
